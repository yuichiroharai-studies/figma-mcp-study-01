...
export default function YourWork() {
 ...
 <p className="css-4hzbpn font-bold text-[36px] text-white tracking-[-0.72px]" data-node-id="2:2548">
            Your work, everywhere you are
          </p>
 <p className="css-4hzbpn leading-[30px] text-[18px] text-white tracking-[-0.36px]" data-node-id="2:2549">
 ...
 <p className="css-ew64yg leading-[30px] text-[18px] text-white tracking-[-0.36px]" data-node-id="2:2551">
            Try Taskey
          </p>
