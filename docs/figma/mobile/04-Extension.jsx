...
export default function Extension() {
  return (
    <div className="bg-[#043873] content-stretch flex flex-col gap-[60px] items-center justify-center px-[16px] py-[80px] relative size-full" data-name="Extension" data-node-id="2:2322">
      <div className="content-stretch flex flex-col gap-[60px] items-center justify-center relative shrink-0 w-full" data-name="Heading" data-node-id="2:2323">
        <div className="content-stretch flex flex-col gap-[24px] items-center justify-center relative shrink-0 w-full" data-name="Text-block" data-node-id="2:2324">
        ...
        <div className="bg-[#4f9cf9] content-stretch flex gap-[10px] items-center justify-center px-[40px] py-[20px] relative rounded-[8px] shrink-0" data-name="Btn-get-started" data-node-id="2:2356">
          ...
          <div className="content-stretch flex items-start relative shrink-0" data-name="Icon" data-node-id="2:2358">
            <div className="relative shrink-0 size-[14px]" data-node-id="2:2359">
      ...
      <div className="content-stretch flex flex-col h-[200px] items-start relative shrink-0 w-full" data-name="Illustration" data-node-id="2:2362">
        <div className="bg-[#c4defd] h-[198.653px] shrink-0 w-full" data-name="Image" data-node-id="2:2363" />
      </div>
    </div>
  );
}