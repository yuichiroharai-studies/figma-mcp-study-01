...
export default function Hero() {
 ...
 <p className="font-bold text-[36px] tracking-[-0.02em]" data-node-id="2:2091">
              Get More Done with whitepace
            </p>
 <p className="leading-[30px] text-[18px] tracking-[-0.02em]" data-node-id="2:2092">
 ...
 <p className="leading-[30px] text-[18px] text-white tracking-[-0.02em]" data-node-id="2:2094">{`Try TasKey Free `}</p>
