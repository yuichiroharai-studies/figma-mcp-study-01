...
export default function YourWork() {
  return (
    <div className="bg-[#043873] content-stretch flex flex-col items-start pb-[140px] pt-[100px] px-[16px] relative size-full" data-name="YourWork" data-node-id="2:2516">
      <div className="content-stretch flex flex-col gap-[60px] items-start relative shrink-0 w-full" data-name="Heading" data-node-id="2:2517">
        <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Text-block" data-node-id="2:2518">
        ...
        <div className="bg-[#4f9cf9] content-stretch flex gap-[10px] items-center justify-center px-[40px] py-[20px] relative rounded-[8px] shrink-0" data-name="Btn-try" data-node-id="2:2550">
          ...
          <div className="content-stretch flex items-start relative shrink-0" data-name="Icon" data-node-id="2:2552">
            <div className="relative shrink-0 size-[14px]" data-node-id="2:2553">
