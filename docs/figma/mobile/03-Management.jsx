...
export default function Management() {
 ...
 <p className="font-bold text-[36px] text-center tracking-[-0.02em]" data-node-id="2:2218">
              Project Management
            </p>
 <p className="leading-[30px] text-[18px] text-center tracking-[-0.02em]" data-node-id="2:2219">
 ...
 <p className="leading-[30px] text-[18px] text-white tracking-[-0.02em]" data-node-id="2:2221">
              Get Started
            </p>
 <div className="flex items-start " data-name="Icon" data-node-id="2:2222">
 <div className=" size-[15px]" data-node-id="2:2223">
 ...
 <p className="font-bold text-[36px] text-center tracking-[-0.02em]" data-node-id="2:2283">
              Work together
            </p>
 <p className="leading-[30px] text-[18px] text-center tracking-[-0.02em]" data-node-id="2:2284">{`With whitepace, share your notes with your colleagues and collaborate on them. You can also publish a note to the internet and share the URL with others. `}</p>
          </div>
 ...
 <p className="leading-[30px] text-[18px] text-white tracking-[-0.02em]" data-node-id="2:2286">
              Try it now
            </p>
