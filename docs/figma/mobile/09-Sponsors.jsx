...
export default function Sponsors() {
  return (
    <div className="flex flex-col gap-[100px] items-center justify-center px-[16px] py-[80px] relative size-full" data-name="Sponsors" data-node-id="2:2654">
      ...
      <p className="css-4hzbpn font-bold leading-[normal] relative text-[#212529] text-[36px] text-center tracking-[-0.72px]" data-node-id="2:2684">
        Our sponsors
      </p>
      <div className="flex flex-col gap-[100px] items-center relative w-full" data-name="sponsors" data-node-id="2:2685">
        ...
        <div className="bg-[#c4defd] h-[46px] w-[139px]" data-name="Placeholder" data-node-id="2:3026" />
      </div>
    </div>
  );
}