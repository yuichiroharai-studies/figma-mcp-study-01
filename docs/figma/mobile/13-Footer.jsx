...
export default function Footer() {
  return (
    <div className="bg-[#043873] content-stretch flex flex-col items-center justify-center pb-[32px] pt-[140px] px-[16px] relative size-full" data-name="Footer" data-node-id="2:2100">
      <div className="content-stretch flex flex-col gap-[80px] items-center justify-center relative shrink-0 w-full" data-name="Content" data-node-id="2:2101">
        <div className="content-stretch flex flex-col gap-[80px] items-center justify-center relative shrink-0 w-full" data-name="Info" data-node-id="2:2102">
          <div className="content-stretch flex flex-col gap-[24px] items-center leading-[0] relative shrink-0 w-full" data-name="Logo-description" data-node-id="2:2103">
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] relative shrink-0" data-name="Logo" data-node-id="2:2104">
          ...
          <div className="content-stretch flex flex-col gap-[23px] items-center justify-center relative shrink-0 w-[201px]" data-name="Try-btn" data-node-id="2:2128">
            ...
            <div className="bg-[#4f9cf9] content-stretch flex gap-[10px] items-center justify-center px-[40px] py-[20px] relative rounded-[8px] shrink-0" data-name="Btn-try" data-node-id="2:2131">
              ...
              <div className="content-stretch flex items-start relative shrink-0" data-name="Icon" data-node-id="2:2133">
                <div className="relative shrink-0 size-[14px]" data-node-id="2:2134">
        ...
        <div className="content-stretch flex flex-col gap-[20px] items-center justify-center relative shrink-0 w-full" data-name="Btm" data-node-id="2:2137">
          <div className="border-[#2e4e73] border-b border-solid content-stretch flex flex-col gap-[20px] items-center justify-center pb-[20px] pt-0 px-0 relative shrink-0 w-full" data-name="Tems and condition" data-node-id="2:2138">
            <div className="content-stretch flex gap-[6px] items-center justify-center relative shrink-0" data-name="Language" data-node-id="2:2139">
              <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Icon" data-node-id="2:2140">
                <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] leading-[0] relative shrink-0" data-name="Group" data-node-id="2:2141">
          ...
          <div className="content-stretch flex gap-[32px] items-center relative shrink-0" data-name="Social Icon" data-node-id="2:2151">
            <div className="h-[16.684px] relative shrink-0 w-[9px]" data-name="_x30_1._Facebook" data-node-id="2:2152">
              <img alt="" className="block max-w-none size-full" src={imgX301Facebook} />
            </div>
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] leading-[0] relative shrink-0" data-name="Twitter" data-node-id="2:2154">
            ...
            <div className="relative shrink-0 size-[15px]" data-name="Linkedin" data-node-id="2:2157">
