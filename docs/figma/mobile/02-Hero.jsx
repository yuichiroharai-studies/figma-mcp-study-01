...
export default function Hero() {
  return (
    <div className="bg-[#043873] flex flex-col items-center justify-center px-[16px] py-[80px] relative size-full" data-name="Hero" data-node-id="2:2020">
      <div className="flex flex-col gap-[100px] items-center justify-center relative w-full" data-name="Heading / Image" data-node-id="2:2021">
        ...
        <div className="flex flex-col items-start relative w-full" data-name="Image-container" data-node-id="2:2098">
