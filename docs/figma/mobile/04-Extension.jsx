...
export default function Extension() {
 ...
 <p className="css-4hzbpn font-bold text-[36px] text-center text-white tracking-[-0.72px]" data-node-id="2:2354">
            Use as Extension
          </p>
 <p className="css-4hzbpn leading-[30px] text-[18px] text-center text-white tracking-[-0.36px]" data-node-id="2:2355">
 ...
 <p className="css-ew64yg leading-[30px] text-[18px] text-white tracking-[-0.36px]" data-node-id="2:2357">
            Let’s Go
          </p>
