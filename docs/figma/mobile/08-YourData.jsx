...
export default function YourData() {
 ...
 <p className="font-bold text-[36px] text-center tracking-[-0.02em]" data-node-id="2:2646">
            100% your data
          </p>
 <p className="leading-[30px] text-[18px] text-center tracking-[-0.02em]" data-node-id="2:2647">{`The app is open source and your notes are saved to an open format, so you'll always have access to them. Uses End-To-End Encryption (E2EE) to secure your notes and ensure no-one but yourself can access them.`}</p>
        </div>
 ...
 <p className="leading-[30px] text-[18px] text-white tracking-[-0.02em]" data-node-id="2:2649">
            Read more
          </p>
