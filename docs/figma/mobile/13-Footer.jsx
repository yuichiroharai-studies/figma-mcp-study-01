...
export default function Footer() {
 ...
 <p className="col-1 css-ew64yg font-bold ml-[47px] mt-0 row-1 text-[28px] text-white" data-node-id="2:2111">
                whitepace
              </p>
            </div>
 ...
 <p className="css-ew64yg leading-[30px] text-[#ffe492]" data-node-id="2:2115">
              Overview
            </p>
 <p className="css-ew64yg leading-[30px] text-white" data-node-id="2:2116">
              Pricing
            </p>
 <p className="css-4hzbpn leading-[30px] text-white w-[177px]" data-node-id="2:2117">
              Customer stories
            </p>
          </div>
 ...
 <p className="css-ew64yg leading-[30px] " data-node-id="2:2120">
              Blog
            </p>
 <p className="css-ew64yg leading-[30px] " data-node-id="2:2121">{`Guides & tutorials`}</p>
 <p className="css-4hzbpn leading-[30px] w-[130px]" data-node-id="2:2122">
              Help center
            </p>
          </div>
 ...
 <p className="css-ew64yg leading-[30px] " data-node-id="2:2125">
              About us
            </p>
 <p className="css-ew64yg leading-[30px] " data-node-id="2:2126">{`Careers `}</p>
 <p className="css-4hzbpn leading-[30px] w-[99px]" data-node-id="2:2127">
              Media kit
            </p>
          </div>
 ...
 <div className="col-1 h-[18.998px] ml-0 mt-0 row-1 w-[19px]" data-name="Group" data-node-id="2:2142">
 ...
 <div className="flex gap-[32px] items-center " data-name="Social Icon" data-node-id="2:2151">
 <div className="h-[16.684px] w-[9px]" data-name="_x30_1._Facebook" data-node-id="2:2152">
              <img alt="" className="block max-w-none size-full" src={imgX301Facebook} />
            </div>
 <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] leading-[0] " data-name="Twitter" data-node-id="2:2154">
 <div className="col-1 h-[13.813px] ml-0 mt-0 row-1 w-[17px]" data-name="Group" data-node-id="2:2155">
                <img alt="" className="block max-w-none size-full" src={imgGroup2} />
              </div>
            </div>
 <div className=" size-[15px]" data-name="Linkedin" data-node-id="2:2157">
