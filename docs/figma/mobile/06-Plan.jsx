...
export default function Plan() {
 ...
 <p className="css-4hzbpn font-bold text-[36px] text-center tracking-[-0.72px]" data-node-id="2:2395">
          Choose Your Plan
        </p>
 <p className="css-4hzbpn leading-[30px] text-[18px] text-center tracking-[-0.36px]" data-node-id="2:2396">
 ...
 <div className="flex flex-col gap-[28px] items-start w-full" data-name="Bullet-point" data-node-id="2:2403">
 <div className="flex gap-[19px] items-center w-full" data-name="Point" data-node-id="2:2404">
 ...
 <div className="flex gap-[19px] items-center w-full" data-name="Point" data-node-id="2:2409">
 ...
 <div className="flex gap-[19px] items-center w-full" data-name="Point" data-node-id="2:2424">
 ...
 <p className="css-4hzbpn font-bold text-[36px] tracking-[-0.72px] w-full" data-node-id="2:2439">
              $11.2
            </p>
 <p className="css-4hzbpn leading-[20px] text-[16px] tracking-[-0.32px] w-full" data-node-id="2:2440">
              Keep home and family on track
            </p>
          </div>
 <div className="flex flex-col gap-[28px] items-start w-full" data-name="Bullet-point" data-node-id="2:2441">
 <div className="flex gap-[19px] items-center w-full" data-name="Point" data-node-id="2:2442">
              <div className="relative size-[18.006px]" data-name="Icon" data-node-id="2:2443">
                <div className="absolute inset-[-5.55%]">
                  <img alt="" className="block max-w-none size-full" src={imgIcon1} />
                </div>
              </div>
 <p className="css-4hzbpn flex-[1_0_0] leading-[20px] min-h-px min-w-px text-[#fefefe] text-[16px] tracking-[-0.32px]" data-node-id="2:2446">
                Sync unlimited devices
              </p>
            </div>
 <div className="flex gap-[19px] items-center w-full" data-name="Point" data-node-id="2:2447">
              <div className="relative size-[18.006px]" data-name="Icon" data-node-id="2:2448">
                <div className="absolute inset-[-5.55%]">
                  <img alt="" className="block max-w-none size-full" src={imgIcon1} />
                </div>
              </div>
 <p className="css-4hzbpn flex-[1_0_0] leading-[20px] min-h-px min-w-px text-[#fefefe] text-[16px] tracking-[-0.32px]" data-node-id="2:2451">{`10 GB monthly uploads `}</p>
            </div>
 ...
 <p className="css-4hzbpn flex-[1_0_0] leading-[20px] min-h-px min-w-px text-[#fefefe] text-[16px] tracking-[-0.32px]" data-node-id="2:2456">{`200 MB max. note size `}</p>
            </div>
 ...
 <p className="css-4hzbpn flex-[1_0_0] leading-[20px] min-h-px min-w-px text-[#fefefe] text-[16px] tracking-[-0.32px]" data-node-id="2:2461">
                Customize Home dashboard and access extra widgets
              </p>
            </div>
 <div className="flex gap-[19px] items-center w-full" data-name="Point" data-node-id="2:2462">
              <div className="relative size-[18.006px]" data-name="Icon" data-node-id="2:2463">
                <div className="absolute inset-[-5.55%]">
                  <img alt="" className="block max-w-none size-full" src={imgIcon1} />
                </div>
              </div>
 <p className="css-4hzbpn flex-[1_0_0] leading-[20px] min-h-px min-w-px text-[#fefefe] text-[16px] tracking-[-0.32px]" data-node-id="2:2466">{`Connect primary Google Calendar account `}</p>
            </div>
 ...
 <p className="css-4hzbpn flex-[1_0_0] leading-[20px] min-h-px min-w-px text-[#fefefe] text-[16px] tracking-[-0.32px]" data-node-id="2:2471">{`Add due dates, reminders, and notifications to your tasks `}</p>
            </div>
          </div>
 ...
 <p className="css-ew64yg leading-[30px] text-[18px] text-white tracking-[-0.36px]" data-node-id="2:2473">
              Get Started
            </p>
          </div>
        </div>
 ...
 <div className="flex flex-col gap-[28px] items-start w-full" data-name="Bullet-point" data-node-id="2:2479">
 <div className="flex gap-[19px] items-center w-full" data-name="Point" data-node-id="2:2480">
 ...
 <div className="flex gap-[19px] items-center w-full" data-name="Point" data-node-id="2:2485">
 ...
 <div className="flex gap-[19px] items-center w-full" data-name="Point" data-node-id="2:2500">
 ...
 <div className="h-[12px] w-[60px]" data-name="Slider" data-node-id="2:2512">
