...
export default function Hero() {
 ...
 <p className="css-4hzbpn font-bold text-[36px] tracking-[-0.72px]" data-node-id="2:2091">
              Get More Done with whitepace
            </p>
 <p className="css-4hzbpn leading-[30px] text-[18px] tracking-[-0.36px]" data-node-id="2:2092">
