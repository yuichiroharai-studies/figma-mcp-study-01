const imgElement = "http://localhost:3845/assets/0d6f146dfe955ab6209483310b0adf38330aff31.svg";
const imgGroup214 = "http://localhost:3845/assets/2ba8c5a9622ff4b67d09e2e234bee6655a3b7f73.svg";
const imgElement1 = "http://localhost:3845/assets/aac94f4ba7434149f9e82a0ec656e655ad63c640.svg";
const imgGroup215 = "http://localhost:3845/assets/e7b19cff4422768f834260cffe792fe79eabc2bf.svg";
      ...
      <div className="content-stretch flex flex-col gap-[60px] items-center justify-center relative shrink-0 w-full" data-name="Content" data-node-id="2:2162">
        <div className="content-stretch flex flex-col gap-[60px] items-center relative shrink-0 w-full" data-name="Headline" data-node-id="2:2163">
          <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full" data-name="Text-block" data-node-id="2:2164">
            ...
            <p className="css-4hzbpn font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-full not-italic relative shrink-0 text-[#212529] text-[36px] text-center tracking-[-0.72px] w-[min-content]" data-node-id="2:2218">
              Project Management
            </p>
            <p className="css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[30px] min-w-full not-italic relative shrink-0 text-[#212529] text-[18px] text-center tracking-[-0.36px] w-[min-content]" data-node-id="2:2219">
          ...
          <div className="bg-[#4f9cf9] content-stretch flex gap-[10px] items-center justify-center px-[40px] py-[20px] relative rounded-[8px] shrink-0" data-name="Btn-get-started" data-node-id="2:2220">
            <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[18px] text-white tracking-[-0.36px]" data-node-id="2:2221">
              Get Started
            </p>
      ...
      <div className="content-stretch flex flex-col gap-[60px] items-center justify-center relative shrink-0 w-full" data-name="Content" data-node-id="2:2227">
        <div className="content-stretch flex flex-col gap-[60px] items-center justify-center relative shrink-0 w-full" data-name="Headline" data-node-id="2:2228">
          <div className="content-stretch flex flex-col gap-[24px] items-center justify-center relative shrink-0 w-full" data-name="Text-block" data-node-id="2:2229">
            ...
            <p className="css-4hzbpn font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-full not-italic relative shrink-0 text-[#212529] text-[36px] text-center tracking-[-0.72px] w-[min-content]" data-node-id="2:2283">
              Work together
            </p>
            <p className="css-4hzbpn font-['Inter:Regular','Noto_Sans:Regular',sans-serif] font-normal leading-[30px] min-w-full not-italic relative shrink-0 text-[#212529] text-[18px] text-center tracking-[-0.36px] w-[min-content]" data-node-id="2:2284">{`With whitepace, share your notes with your colleagues and collaborate on them. You can also publish a note to the internet and share the URL with others. `}</p>
          </div>
          <div className="bg-[#4f9cf9] content-stretch flex gap-[10px] items-center justify-center overflow-clip px-[40px] py-[20px] relative rounded-[8px] shrink-0" data-name="Btn-get-started" data-node-id="2:2285">
            <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[18px] text-white tracking-[-0.36px]" data-node-id="2:2286">
              Try it now
            </p>
